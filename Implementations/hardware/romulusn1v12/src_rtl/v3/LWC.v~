module LWC (/*AUTOARG*/
   ...
   mode_top datapath (
		      ...
		      yrst, yenc, yse, zrst, zenc, zse, erst, correct_cnt, constant, constant2, constant3, constant4, tk1s
		      ) ;
   api control (
		// Outputs
		do_data, pdi, pdi_ready, sdi_ready, do_valid, do_last, domain,
		srst, senc, sse, xrst, xenc, xse, yrst, yenc, yse, zrst, zenc, zse,
		erst, decrypt, correct_cnt, constant, constant2, constant3, constant4, tk1s,
		// Inputs

...
[Performances and implementations](https://github.com/romulusae/romulus/blob/master/index.md#performances-and-implementations)

|| 
|:--:| <!-- table header/body separator with center formatting -->
| [Team](https://github.com/romulusae/romulus/blob/master/index.md#team) | <!-- cell gets column's alignment -->
